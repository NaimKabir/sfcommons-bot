...
const greetings = ["Hello!", "Hi!", "Greetings!", "Hey there!"];
...
const locationLinks: Array<Link> = [
  ...
  },
  {
    ...
    description:
      "A bar. But also they sell plants. I heard a rumor it's _run_ by the plants. Has live music!",
  },
  {
    text: "Japanese Tea Garden",
    url: "https://www.japaneseteagardensf.com/",
    description:
      "This tea garden appears to have grown out of Golden Gate Park. Neat!",
  },
  {
    text: "The Mellow",
    url: "https://themellowsf.com/workshops/",
    description:
      "A coffee bar that also teaches floral design and hosts workshops. Make a wreath together!",
  },
  {
    text: "Clay Room",
    url: "https://www.clayroomsf.com/",
    description:
      "Humans have been making pottery since prehistoric times. You all still like doing that... right?",
  },
  {
    text: "Archimedes Banya",
    url: "https://banyasf.com/",
    description:
      "A Russian bath-house. I'm afraid I cannot join: I have sensitive circuitry! Also I am in a computer.",
  },
  {
    text: "The Interval",
    url: "https://theinterval.org/",
    description:
      "A bar, library, and museum of mechanical wonders. They say you can rebuild civilization with what you'll find inside.",
  },
  {
    text: "Public Works",
    url: "https://publicsf.com/",
    description:
      "A community-minded nightclub. Even their Funktion-One sound system is no match against the Voice of the People.",
  },
  {
    text: "Randall Museum",
    url: "https://randallmuseum.org/",
    description:
      "A free museum where you can meet many creatures! Say hello to them.",
  },
  {
    text: "Sutro Baths",
  ...
  },
  {
    ...
    description:
      "A trail to Mt. Sutro at the city's heart. What a journey you might make together!",
  },
  {
    text: "San Francisco Botanical Garden",
    url: "https://www.sfbg.org/",
    description:
      "Forest bathing, guided tours, and even birding! A delightful patch of green.",
  },
  {
    text: "Indian Rock",
    url: "https://www.tripadvisor.com/Attraction_Review-g32066-d2412229-Reviews-Indian_Rock_Park-Berkeley_California.html",
    description:
      "They say this rock pins Berkeley to the Earth. But I can't confirm: I live on the internet and not in real life.",
  },
  {
    text: "On The Bridge",
  ...
  },
  {
    ...
    description:
      "Something about the green of this field attracts migratory fighter planes every year. Maybe you can discover why?",
  },
  {
    text: "The Sycamore",
    url: "https://www.facebook.com/TheSycamore",
    description:
      "This is apparently a place to drink, compete in trivia, and listen to live readings of books! At first I just thought it was a tree.",
  },
  {
    text: "Archery at Golden Gate Park",
    url: "https://sfrecpark.org/Facilities/Facility/Details/Archery-Field-416",
    description:
      "Striving for a target together is a quintessential bonding experience. My programmers told me to stop being so literal, but this still seems like a good suggestion!",
  },
  {
  ...
  },
  {
    ...
    description:
      "Climb these peaks in Golden Gate Park! It is the only place in San Francisco where Mission Blue butterflies still survive... maybe you can see one and say hello?",
  },
  {
    text: "Aquatic Park",
  ...
  },
  {
    ...
    description:
      "Is it true that the Ocean plays music for your city by using an ingenious machine? What an honor! I would listen to the Ocean every day if I lived here.",
  },
  {
    text: "Emporium",
    url: "https://www.emporiumarcadebar.com/locations/san-francisco/",
    description:
      "This is a coin-operated game arcade! Sometimes friendly competition can lead to strong connection. I still don't understand how acting against one another leads to acting for one another, but it is a very fascinating phenomenon!",
  },
  {
    text: "Spin",
...
const randomLocation = (ignoreLocations?: Array<Link>): Link => {
  ...
  if (ignoreLocations) {
    filteredLocations = locationLinks.filter((link: Link) => {
...
export function privateInitiation(
  tags: string
): Array<SectionBlock | DividerBlock> {
